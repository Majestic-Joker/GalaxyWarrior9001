class EnemyM extends AI {
    ...
    moveDown() {
        this.obj.setVelocity(0, .5 * this.scene.plySpd);
    ...
    strafe() {
        ...
        if (!this.strafing) {
            this.strafing = true;
            // Go right
            this.obj.setVelocity(.5 * this.scene.plySpd, 0);
        }
    ...
    charge() {
        ...
        let xSpd = Math.cos(angle) * this.scene.plySpd * .50;
        let ySpd = Math.sin(angle) * this.scene.plySpd * .50;
